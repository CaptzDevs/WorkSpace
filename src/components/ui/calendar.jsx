...
/*   const formatCaption = (month) => {
    // Get the BE year (Buddhist Era) by adding 543 to the current year
    const beYear = dayjs(month).year() + 543;
    // Format the month name in Thai using dayjs with Thai locale
    const monthName = dayjs(month).locale('th').format('MMMM');
